...
class PedidoModel extends Model {
    ...
    public static function crearPedido($proovedor, $tipo_documento, $codigo_documento, $fecha, $notas_adicionales, $subtotal, $igv, $total){
        $conexion = Database::connect();
        $sql = "INSERT INTO pedidos (proovedor, tipo_documento, codigo_documento, fecha, notas_adicionales, subtotal, igv, total) 
        VALUES (:proovedor, :tipo_documento, :codigo_documento, :fecha, :notas_adicionales, :subtotal, :igv, :total)";
